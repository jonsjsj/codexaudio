...
App              CustomTab                 ABS-1                 Authentik              ABS-2
 ...
 |-- open ------->| {abs1}/auth/openid?...redirect_uri=codexaudio://oauth&state=s1
 |                |------------------------>|--302 authorize------>|
 ...
 |                |<--302 callback----------|<--code---------------|
 |<-codexaudio://oauth?code=...&state=s1  (via /auth/openid/mobile-redirect)
 ...
 |<-codexaudio://oauth?code=...&state=s2 --------------------------------------|
